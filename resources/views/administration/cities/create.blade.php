                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cadastrar uma Cidade</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="city" class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }} {{ isset($item->city) ? 'active' :null }}" required value="{{ isset($item->city) ? $item->city : old('city') }}" autofocus>
                                                        @if ($errors->has('city'))
