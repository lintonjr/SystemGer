                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cadastrar uma Zona</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="district" class="form-control {{ $errors->has('district') ? 'is-invalid' : '' }} {{ isset($item->district) ? 'active' :null }}" required value="{{ isset($item->district) ? $item->district : old('district') }}" autofocus>
