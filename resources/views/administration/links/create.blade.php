                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cadastrar um Vínculo</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="link" class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }} {{ isset($item->link) ? 'active' :null }}" required value="{{ isset($item->link) ? $item->link : old('link') }}" autofocus>
                                                        @if ($errors->has('link'))
