                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cadastrar um Tipo de Atendimento</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    <h5>Tipo de Atendimento
                                                        <span class="required">*</span>
                                                    </h5>
                                                    <div class="controls">
                                                        <input type="text" name="type" class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }} {{ isset($item->type) ? 'active' :null }}" required value="{{ isset($item->type) ? $item->type : old('type') }}" autofocus>
                                                        @if ($errors->has('type'))
