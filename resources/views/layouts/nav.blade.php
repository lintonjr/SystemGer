<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-light navbar-shadow bg-success
">
			...
			<ul class="nav navbar-nav flex-row">
				...
				<li class="nav-item mr-auto">
                    <a class="navbar-brand" href="{{ route('index') }}">
						{{-- <img class="brand-logo" alt="DOE" src="{{ asset('img/logoImg.png') }}"> --}}
						{{-- <h3 class="brand-text"><img class="brand-logo" alt="DOE" src="{{ asset('img/COLOR.png') }}" style="width:115px"></h3> --}}
					</a>
				</li>
				...
				<ul class="nav navbar-nav float-right">
					...
					<li class="dropdown dropdown-user nav-item">
						<a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
							<span class="mr-1">Olá, {{\Auth::user()->name}}
								<span class="user-name text-bold-700">{{ Auth::user()->nome }}</span>
							</span>
							<span class="avatar avatar-online">
								@if(Auth::user()->foto_url)
									<img src="{{ url(Auth::user()->foto_url)}}">
								@else
									<img src="{{ url('img/avatars/avatar-blank.png')}}">
								@endif
								<i></i>
							</span>
						</a>
									...
									<div class="media">
										<div class="media-left">
											<span class="avatar avatar-sm avatar-online rounded-circle">
												<img src="{{ asset('modern/images/portrait/small/avatar-s-19.png') }}" alt="avatar">
												<i></i>
											</span>
										</div>
										<div class="media-body">
									...
									<div class="media">
										<div class="media-left">
											<span class="avatar avatar-sm avatar-busy rounded-circle">
												<img src="{{ asset('modern/images/portrait/small/avatar-s-2.png') }}" alt="avatar">
												<i></i>
											</span>
										</div>
										<div class="media-body">
