                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cadastrar um conjunto de Permissões</h4>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="description" class="form-control {{ isset($item->description) ? 'active' :null }}" required value="{{ isset($item->description) ? $item->description : old('description') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
