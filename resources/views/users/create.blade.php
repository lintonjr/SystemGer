                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="email" name="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }} {{ isset($item->email) ? 'active' :null }}" required value="{{ isset($item->email) ? $item->email : old('email') }}">
                                                        @if ($errors->has('email'))
