                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Adicionar Papel à {{$item->name}}</h4>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-10 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select class="select2 form-control" name="role_id[]" multiple="multiple">
                                                        <option value="">Papeis</option>
                                                        @foreach ($roles as $role)
                                                            @if(isset($item->role_id))
                                                                <option value="{{$role->id}}" {{ $item->role_id == $role->id ? 'selected': null }}>{{$role->name}}</option>
                                                            @else
        ...
        <section id="configuration">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Listagem de Papeis de {{$item->name}}</h4>
                            <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
